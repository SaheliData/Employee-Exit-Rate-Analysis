libname Project "\\Client\H$\Documents\IUB_Sem\Spring\SPEA507\Project\Rewagad_Kumar_Saha";
proc import datafile = "\\Client\H$\Documents\IUB_Sem\Spring\SPEA507\Project\Rewagad_Kumar_Saha\P507_HRData.csv" out = Project.data
dmbs = csv replace;
run;
data Project.data;
